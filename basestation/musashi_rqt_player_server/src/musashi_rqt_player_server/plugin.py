...
class PlayerServerPlugin(Plugin):
    def __init__(self, context):
        ...
        # パブリッシャー作成
        self._pub_player_states = self._node.create_publisher(
            PlayerStates,
            '/player_states',
            10
        )
    ...
    def load_parameters(self):
        ...
        self._node.get_logger().info(
            f'Loaded parameters: team_color={self._team_color}, num_players={self._num_players}, '
    ...
    def _map_targeted_command(self, cmd, target_team):
        ...
        # 自チームか相手かを判定
        is_own = (target_team == constants.TEAM_IP)
    ...
    def timer_callback_player_states_publish(self,):
        ...
        self._player_states.header.stamp = now
        self._pub_player_states.publish(self._player_states)
        return
